...
//				.setParameter("lowest", lowest).setParameter("highest", highest).getResultList();
//		return mods;
//	}
...
//		@SuppressWarnings("unchecked")
//		List<Model> mods = entityManager.createQuery(
//				"select m from Model m where m.price >= :lowest and m.price <= :highest and m.woodType like :wood")
//				.setParameter("lowest", lowest).setParameter("highest", highest).setParameter("wood", "%" + wood + "%")
//				.getResultList();
//		return mods;
//	}
